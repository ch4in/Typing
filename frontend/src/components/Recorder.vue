<template>
  <div :class="{fixedClass:isFixed}">
    <el-card shadow="always" class="info" :body-style="{ padding: '0 10px' }">
      <el-row>
        <el-col :span="6">
          <el-tooltip
            v-if="unit === 'Cn'"
            ...
            placement="bottom"
          >
            <el-button>速度</el-button>
            <span>速度：{{ speed }} WPM(字/分)</span>
          </el-tooltip>
          <el-tooltip v-else effect="dark" content="Keystrokes Per Minute" placement="bottom">
            <el-button>速度</el-button>
        ...
        <el-col :span="6">
          <el-button size="mini" @click="timePause()">{{this.isPause ? '开始' :'暂停'}}</el-button><span> 还可以暂停{{pauseTime}}次</span>
        </el-col>
        <el-col :span="6">
